    ...
    <>
      ...
      <main id="main" className="bg-deep">
        <div className="mx-auto flex min-h-[70vh] max-w-[820px] flex-col justify-center px-5 py-32 md:px-11">
          ...
          <p className="mb-10 max-w-[52ch] text-[17px] leading-[1.65] text-on-dark md:text-[18px]">
            {copy.body}
          </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-8">
            <Link
              href="/"
              className="btn-light inline-flex items-center justify-center gap-3 self-start rounded-full bg-white px-9 py-4 text-[16px] text-deep"
            >
            ...
            {hasGuides && (
              <Link
                href="/guide"
                className="inline-flex items-center gap-2.5 self-start text-[15px] text-on-dark-strong underline underline-offset-4"
              >
                {copy.guides}
              </Link>
            )}
