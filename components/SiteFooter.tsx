...
export default function SiteFooter({ footer }: { footer: { location: string; tagline: string } }) {
  return (
    <footer className="relative flex flex-col justify-between gap-2 border-t border-white/[0.18] px-5 py-6 text-caption text-white/65 sm:flex-row sm:gap-5 md:px-10">
